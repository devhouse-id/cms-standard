                                ...
                                <div class="card-block">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            ?>
                                                <input type="text" class="form-control" value="<?php echo $row->$column['name'];?>" readonly="">
                                            <?php 
                                                } else {
                                            ?>
                                                <input type="text" class="form-control" value="<?php echo $row->$column['name'];?>">
                                            <?php
                                                }
                                            } elseif ($type == 'text_area') {
                                            ?>
                                                <textarea rows="5" cols="5" class="form-control" placeholder="Default textarea"><?php echo $row->$column['name'];?></textarea>
                                            <?php
                                            } elseif ($type == 'options') {
                                            ?>
